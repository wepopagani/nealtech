...
const services = [
  ...
  },
  {
    ...
    description:
      "Un nostro interior designer interno si occupa di studiare e arredare i tuoi spazi con rendering fotorealistici, valorizzando ogni ambiente agli occhi dei potenziali acquirenti.",
    features: [
